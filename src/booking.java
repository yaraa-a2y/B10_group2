...
public class booking {
    ...
    booking (int room_num ,int time ,String date ,int days,int room_type ,int price_range ,int num_of_people ,int booking_number ,String name,int id,service serviceName){
